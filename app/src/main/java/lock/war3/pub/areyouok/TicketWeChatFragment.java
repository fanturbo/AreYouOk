...
public class TicketWeChatFragment extends DialogFragment {

    public static final String TAG = TicketWeChatFragment.class.getSimpleName();
    ...
    public static TicketWeChatFragment newInstance(int i) {
        Bundle args = new Bundle();
        args.putInt("i", i);
        TicketWeChatFragment fragment = new TicketWeChatFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.view_bus_ticket_wechat, container, false);
